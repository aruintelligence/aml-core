...
test('external verifier harness consumes the case corpus and retains exact hash bindings', () => {
  ...
  assert.match(harness, /challenge_sha256/);
  assert.match(harness, /challenge_cases_sha256/);
  assert.match(harness, /witness_vector_sha256/);
