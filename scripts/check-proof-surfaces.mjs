...
const required = [
  ...
  ['docs/aml.js', ['aml-browser-bootstrap/1', './aml-gate.js', './aml-zone.js', './aml-live.js', './aml-page-manifest.js', './aml-browser-evidence.js', 'globalThis.AML = api', 'createChallenge', 'verifyWitnessBundle']],
